			...
			<table  id='table_admin'>
				...
				<tr>
				  ...
				  <tr>
					<td>Price</td>
					<td>
					  <input type="text" name="Price" id="textfield2">Rupees</td>
				  </tr>
				  <tr>
					<td >Price_category</td>
					<td ><select name="P_cate" >
					<option value="1">Rs45-Rs55</option>
					<option value="2"/>Rs55-Rs65</option>
					<option value="3"/>Rs65-Rs85</option>
					<option value="4">Rs85-Rs100</option>
					</select>
					</td>
