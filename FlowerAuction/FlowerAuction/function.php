...
function getpro_cat(){
	if(isset($_GET['cat'])){
		$cat_id=$_GET['cat'];
		global $con;
		$get_cat_pro="SELECT * from flower where item_cat=$cat_id  ";
		$run_cat_pro=mysqli_query($con,$get_cat_pro);
		while($row_cat_pro= mysqli_fetch_array($run_cat_pro)){
			$pro_id=$row_cat_pro["flower_id"];
			...
			echo"
		<div id='single_pro'>
		<a href='detail.php?flower_id=$pro_id'><img src='pic/$pro_image' alt='flowers' width='200' height='200'/></a>
		<h3>$pro_Name</h3>
		<p>Rs $pro_Price</p>
		</div>
		";
...
function result(){
		if(isset($_GET['search'])){
			...
			global $con;					 
			$get_pro="SELECT * from flower where Search_key like '%$search_query%' ";
			...
			while($row_pro= mysqli_fetch_array($run_pro)){
				...
				echo"
				<div id='single_pro'>
				<a href='detail.php?flower_id=$pro_id'><img src='pic/$pro_image' alt='flowerDetail' width='200' height='200'/></a>
				<h3>$pro_Name</h3>
				<p>Rs $pro_Price</p>
				</div>
