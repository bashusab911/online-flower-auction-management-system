...
<html>
	<head>
	  ...
	  <title>OnlineFLowerShop</title>
	  <meta http-equiv="Content-Type" content="text/html; charset=us-ascii" />
	  <meta name="description" content="OnlineFlowerShop">
	...
	$server="localhost";
        ...
        //this is going to take a product from items table base on the category
         ...
         $pro_id=$_GET['flower_id'];
		 $get_pro="SELECT * from flower WHERE flower_id='$pro_id'";
	...
	?>	 
		...
		<!-- make a side bar -->
				...
				<tbody>
				  ...
				  <tr>
					<td width="200" height="50" >Phone:</td>
					<td width="466"><input name="Phone" type="text" id="Phone" title="Phone" maxlength="10"></td>
					<td id="msg2"></td>
				  </tr>
				  <tr>
					<td width="200" height="80" >Account</td>
					<td width="466"><input name="Account" type="text" id="Account" title="Account" maxlength="200"></td>
					<td id="msg3"></td>
				  </tr>
				  <tr>
		...
		<!-- make a Footer -->
		<div id='footer1'>
		Copyright© Call Lilly Only 2023. 
	    All rights reserved.
		</div>
